...
/// <summary>
/// Validator for the UpdateSapAccountCommand.
/// </summary>
internal sealed class UpdateSapAccountCommandValidator : AbstractValidator<UpdateSapAccountCommand>
{
    public UpdateSapAccountCommandValidator()
    {
